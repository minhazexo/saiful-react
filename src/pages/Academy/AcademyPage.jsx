    ...
    <div className="page">
      ...
      <section className="section modules-section">
        <div className="container">
          ...
          <MobileCarousel className="modules-grid">
            {MODULE_KEYS.map((key, i) => (
              <motion.div key={key} className="module-card" initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }}>
        ...
        <div className="container">
          ...
          <MotionFadeUp className="pricing-box" amount={0.15}>
            ...
            <ul className="pricing-features">
              {PERK_KEYS.map((key) => (
                <motion.li key={key} initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }}>
        ...
        <div className="container">
          <div className="enrollment-grid">
            ...
            >
              ...
              <MobileCarousel className="enrollment-perks">
                {PERK_KEYS.slice(0, 4).map((key) => (
                  <motion.div key={key} className="enrollment-perk" initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }}>
