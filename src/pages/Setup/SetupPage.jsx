    ...
    <div className="page">
      ...
      <section className="section">
        <div className="container">
          ...
          <MobileCarousel className="services-grid">
            {SERVICE_KEYS.map((key, i) => {
              const features = t(`setup.services.items.${key}.features`);
              const featureList = Array.isArray(features) ? features : [];
              return (
                <motion.div key={key} className="service-card" initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }}>
      ...
      <section className="section process-section">
        <div className="container">
          ...
          <MobileCarousel className="process-grid">
            {PROCESS_KEYS.map((key, i) => (
              <motion.div key={key} className="process-step" initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }}>
